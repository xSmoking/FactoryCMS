    ...
    <div id="meio">
        ...
        if (mysql_num_rows($mybotsql) > 0) {
            while ($mybots = mysql_fetch_array($mybotsql)) {
                echo $mybots['name'] . ' (<a href="edit/' . $mybots['id'] . '" class="a">editar</a>)<br />';
            }
        } else {
        ...
        <form action="" method="post">
            ...
            <input type="text" name="name" id="name" maxlength="12" /><br /><br />

            Qual vai ser a miss&atilde;o do BOT?<br />
            <input type="text" name="motto" id="motto" size="40" maxlength="25" /><br /><br />
            ...
            <!--
            Em qual posi&ccedil;&atilde;o o BOT ir&aacute; ficar?<br />
            <table>
                <tr>
                    <td><img src="<?php echo $default; ?>&direction=2&head_direction=2&gesture=sml&action=&size=s" alt="posicao" /></td>
                    <td><img src="<?php echo $default; ?>&direction=4&head_direction=4&gesture=sml&action=&size=s" alt="posicao" /></td>
                    <td><img src="<?php echo $default; ?>&direction=6&head_direction=6&gesture=sml&action=&size=s" alt="posicao" /></td>
                    <td><img src="<?php echo $default; ?>&direction=8&head_direction=8&gesture=sml&action=&size=s" alt="posicao" /></td>
                </tr>
                <tr>
                    <td><input style="margin-left:13px;" type="radio" name="posicao" value="2" /></td>
                    <td><input style="margin-left:13px;" type="radio" name="posicao" value="4" /></td>
                    <td><input style="margin-left:13px;" type="radio" name="posicao" value="6" /></td>
                    <td><input style="margin-left:13px;" type="radio" name="posicao" value="8" /></td>
                </tr>
            </table>
            <br /><br />
            
            O BOT ir&aacute; ficar parado ou andando?<br />
            <select name="walk_mode">
                <option value="stand">Parado</option>
                <option value="freeroam">Andando</option>
            </select><br /><br />
            -->
            <input type="hidden" name="action" value="submit" id="action" />
            <input type="submit" value="Comprar BOT" id="submit" />
        </form>
        <br />
        <?php
        if (isset($mensagem)) {
