...
if ($_POST['action'] == "submit") {
    ...
    if ((!$name) || (!$motto) || (!$room_id) || (!$look)) {
        ...
        if (mysql_num_rows($verificabot) > 0) {
            ...
            $msg_type = "success";
            $mensagem = "BOT atualizado com sucesso! Voc&ecirc; j&aacute; pode entrar no quarto.";
        }
    }
}
        ...
        if (mysql_num_rows($mybotsql) > 0) {
            ...
            <form role="form" action="" method="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" id="name" maxlength="12" id="name" value="<?php echo $botarray['name']; ?>" />
                </div>
                <div class="form-group">
                    <label for="motto">Qual vai ser a miss&atilde;o do BOT?</label>
                    <input type="text" class="form-control" name="motto" id="motto" size="40" maxlength="25" value="<?php echo $botarray['motto']; ?>" />
                </div>
                <div class="form-group">
