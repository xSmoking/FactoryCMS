...
if($_POST['action'] == "create_news"){
    ...
    if((!$title) || (!$content)){
        ...
        mysql_query("INSERT INTO cms_news_slider(title, longstory, author, published, date, hour) VALUES('". $title ."', '". $content ."', '". $author ."', '". $published ."', '". $date_normal ."', '". date("H:i") ."')") or die(mysql_error());
    ...
    <div id="big-box">
        ...
        <form action="" method="post">
            <table width="100%">
                ...
                <tr>
                    <td>
                        <button type="submit" id="submit" class="btn btn-primary">Criar Notícia</button>
                        <input type="hidden" id="hidden" name="action" value="create_news" />
                    </td>
